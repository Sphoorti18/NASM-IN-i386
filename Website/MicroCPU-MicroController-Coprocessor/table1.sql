...
('Register File', '32-bit General purpose registers', '8 80-bit registers for floating-point operations', '8-bit registers (Accumulator, B, C, D, E, H, L, Flag register)'),
('Memory Architecture', 'Segmented memory management', 'No dedicated memory', 'Harvard architecture (Separate program and data memory)'),
